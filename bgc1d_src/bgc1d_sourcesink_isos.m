 function [sms diag] =  bgc1d_sourcesink_isos(bgc,t); 
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 if ~bgc.RunIsotopes 
     ...
     % (3) Nitrite oxidation (molN-units):
     %----------------------------------------------------------------------
     %Nitrox = bgc.KNo .*  mm1(t.o2,bgc.KO2No) .* mm1_Iso(t.no2,t.i15no2,bgc.KNO2No); % oxic nitrite oxidation
 ...
 %---------------------------------------------------------------------- 
 sms.o2   =  (-bgc.OCrem .* RemOx - 1.5.*Ammox);% - 0.5 .* Nitrox); %take out nitrox term for anoxic nitrox
 ...
 sms.n2o = (p4nh4 .* sms.n2oind.ammox ...
	 ...
	 sms.i15no3 = bgc.r15no2 .* bgc.alpha_nitrox .* Nitrox ...
            ...
            - bgc.r15no3 .* bgc.alpha_den4 .* bgc.NCden4 .* RemDen4;
	 sms.i15no2 = bgc.r15nh4 .* (bgc.alpha_ammox_no2 .* Jno2_hx) ...
                ...
                - bgc.r15no2 .* bgc.alpha_hybrid_n2o .* Jnn2o_hy; % internal NO2- source: take this last line out
	 sms.i15nh4 = bgc.r15norg.* bgc.NCrem .* (RemOx + RemDen1 + RemDen2 + RemDen3 + RemDen4) ...
                ...
                - bgc.r15nh4 .* bgc.alpha_hybrid_n2o .* Jnn2o_hy;
	 % N2O indivisual SMS 
     ...
     sms.i15n2oA = p2nh4 .* bgc.alpha_ammox_n2oA .* sms.n2oind.ammox ...
                 ...
                 + p2no3 .* bgc.alpha_den4A  .* sms.n2oind.den4 ...
                 + bgc.r15n2oA .* bgc.alpha_den3_Alpha .* sms.n2oind.den3 ...
                 + (p2hybrid + p3hybrid) ./ 2 .* bgc.alpha_hybrid_n2oA .* sms.n2oind.hybrid;
     sms.i15n2oB = p3nh4 .* bgc.alpha_ammox_n2oB .* sms.n2oind.ammox ...
                 ...
                 + p3no3 .* bgc.alpha_den4B  .* sms.n2oind.den4 ...
                 + bgc.r15n2oB .* bgc.alpha_den3_Beta .* sms.n2oind.den3 ...
                 + (p2hybrid + p3hybrid) ./ 2 .* bgc.alpha_hybrid_n2oB .* sms.n2oind.hybrid;
