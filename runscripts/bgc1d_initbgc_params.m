...
%%%%%%% Ammonification %%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bgc.Krem = 0.041/86400 ; % Max. specific remineralization rate (1/s) - Tiano (2014) offshore max rate, based on POCmax = 3.2 µM
%bgc.Krem = 0.0074/86400 ; % 0.08/86400 % Tiano (2014) offshore oxycline rate, based on POCmax = 3.2 µM
%bgc.Krem = 0.45/86400 ;  % Max. specific remineralization rate (1/s) - Tiano (2014) station m1 (coastal) max rate, based on POCmax = 3.2 µM
...
%bgc.KDen1 = 0.00078/86400; % Max. denitrif1 rate (1/s) - Nicole light & rates paper coastal
%bgc.KDen1 = 0.0029/86400; % Max. denitrif1 rate (1/s) - Nicole light & rates paper offshore
bgc.KDen1 = 0.0024/86400; % Max. denitrif1 rate (1/s) - CLK ETNP 2018 rates
...
bgc.KDen2 = 0.0005/86400; %0.000073/86400;   % Max. denitrif2 rate (1/s) - CLK ETNP 2018 rates
...
bgc.KDen3 = 0.02/86400; %0.00090/86400;   % Max. denitrif3 rate (1/s)  - Sun 2021b
...
bgc.KDen4 = 0.015/6/(86400); %0.00046/6/(86400);  % Max. denitrif2 rate (1/s) - CLK ETNP 2018 rates
