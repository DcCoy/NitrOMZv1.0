...
switch bgc.region
case 'ETNP'
	bgc.poc_flux_top = -11.0/86400; %-6.0/86400*1.00; % Bry cond. for top POC Flux            (mmolC/m2/s) %v5.4: -7.0/86400;
    ...
    bgc.d15no3_top = 10.8883;              % Bry cond. for surface del15NO3        (permil)
    bgc.d15no3_bot = 6.4018;              % Bry cond. for deep del15NO3           (permil)
    bgc.d15no2_top = 1.2774;               % Bry cond. for surface del15NO2        (permil)
    bgc.d15no2_bot = -32.7035;             % Bry cond. for deep del15NO2           (permil)
    bgc.d15nh4_top = 15.0;              % Bry cond. for surface del15NH4        (permil)
    bgc.d15nh4_bot = 5.0;               % Bry cond. for deep del15NH4           (permil)
    bgc.d15n2oA_top = 18.5201;             % Bry cond. for surface delN2O-A        (permil)
    bgc.d15n2oA_bot = 22.1587;            % Bry cond. for deep delN2O-A           (permil)
    bgc.d15n2oB_top = -3.4409;             % Bry cond. for surface delN2O-B        (permil)
    bgc.d15n2oB_bot = -2.5703 ;             % Bry cond. for deep delN2O-B           (permil)	
