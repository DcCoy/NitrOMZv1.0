 ...
 bgc.alpha_ammox_no2 = 1.0 / (1.0 + bgc.eps_ammox_no2./1000.0);  % Fractionation factor during ammox (permil)
 % Alpha for ammox -- NH4-->N2O:
 bgc.alpha_ammox_n2o = 1.0 / (1.0 + bgc.eps_ammox_n2o./1000.0);  % Fractionation factor during N2O prod. via NH2OH (permil)
 bgc.alpha_ammox_n2oA = 1.0 / (1.0 + bgc.eps_ammox_n2oA./1000.0);  % Fractionation factor during N2O prod. via NH2OH (permil)
 bgc.alpha_ammox_n2oB = 1.0 / (1.0 + bgc.eps_ammox_n2oB./1000.0);  % Fractionation factor during N2O prod. via NH2OH (permil)
 % Alpha for nitrif-denitrif -- NH4-->NO2:
 bgc.alpha_nden_no2 = 1.0 / (1.0 + bgc.eps_nden_no2./1000.0);    % Fractionation factor during nitrifier-denitrification (permil)
 ...
 bgc.alpha_nitrox = 1.0 / (1.0 + bgc.eps_nitrox./1000.0);        % Fractionation factor during nitrox (permil)

 %%%%%%% Denitrification %%%%%%%%
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 % Alpha for den1 -- NO3-->NO2
 bgc.alpha_den1 = 1.0 / (1.0 + bgc.eps_den1./1000.0);          % Fractionation factor during denitrification 1 (permil)
 ...
 bgc.alpha_den3_Beta = 1.0 / (1.0 + bgc.eps_den3_Beta./1000.0);          % Fractionation factor during denitrification 3 (permil)

 %%%%%%%%%%% Anammox %%%%%%%%%%%%
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 % Alpha for Anammox -- NO2-->N2
 bgc.alpha_ax_no2 = 1.0 / (1.0 + bgc.eps_ax_no2./1000.0);        % Fractionation factor during anammox (permil)
 % Alpha for Anammox -- NH4-->N2
 bgc.alpha_ax_nh4 = 1.0 / (1.0 + bgc.eps_ax_nh4./1000.0);       % Fractionation factor during anammox (permil)
