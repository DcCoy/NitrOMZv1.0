...
xlabel('N_2O \rightarrow N_2')
 ...
 for i = 1:length(pocvals)
    ...
    subplot(2,2,1)
    plot(bgc.no2ton2o, bgc.zgrid, 'color', color,'linewidth',3,'linewidth',3)
    hold on; box on;

    subplot(2,2,2)
    plot(bgc.no3ton2o, bgc.zgrid, 'color', color,'linewidth',3,'linewidth',3)
    hold on; box on;

    subplot(2,2,3)
    plot(bgc.nh4ton2o, bgc.zgrid, 'color', color,'linewidth',3,'linewidth',3)
    hold on; box on;

    subplot(2,2,4)
    plot(bgc.n2oton2, bgc.zgrid, 'color', color,'linewidth',3,'linewidth',3)
    hold on; box on;
end
